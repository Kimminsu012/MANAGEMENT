...
public class QSalesEntity extends EntityPathBase<SalesEntity> {
    ...
    public final EnumPath<com.example.HMS_MANAGEMENT.constent.CutStatus> cutStatus = createEnum("cutStatus", com.example.HMS_MANAGEMENT.constent.CutStatus.class);
